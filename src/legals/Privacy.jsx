...
export default function PrivacyPolicy() {
  return (
    <div style={{ fontFamily: "sans-serif", maxWidth: "800px", margin: "auto", padding: "2rem" }}>
      ...
      <p>Your information is used to provide and improve our service, personalize your experience, and maintain account security.</p>

      <h2>3. Cookies</h2>
      <p>We use cookies and similar technologies for essential site functions and analytics. You can control cookie usage through your browser settings.</p>
